...
public class TopologicalSorter
{
    ...
    {
        // Iterative
        //var predecessorsCount = this.PredecessorsCount();
        //return this.IterativeSort(predecessorsCount);
    ...
    private ICollection<string> IterativeSort(Dictionary<string, int> predecessorsCount)
    {
